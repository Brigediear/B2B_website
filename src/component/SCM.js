...
<a href="Management Consulting" style={{ textDecoration: "none" }}>    
...
>
    <div style={{
        ...
        backgroundImage:" url('ManagementConsulting.jpg')", // Specify image URL
...
>
    <div style={{
        ...
        height: '40%', // Set height to half of the container
        width: '100%', // Set width to fill the container
        backgroundImage:" url('upgrade and migration services.png')", // Specify image URL
        backgroundSize: 'cover', // Cover to fill the div
        backgroundPosition: 'center' // Center the image
    }}></div>
    <div style={{
...
>
    <div style={{
        ...
        height: '40%', // Set height to half of the container
        width: '100%', // Set width to fill the container
        backgroundImage:" url('managed_services.png')", // Specify image URL
        backgroundSize: 'cover', // Cover to fill the div
        backgroundPosition: 'center' // Center the image
    }}></div>
    <div style={{
