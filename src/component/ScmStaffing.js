...
const Staffing_IS_IT = () => {
    ...
    return (
        <div className='containerStyle' style={{ alignItems: 'center', backgroundColor: 'white', width: 'auto' }}>
            {/* Banner section */}
            <div style={{
                backgroundImage: "url('/staffing_IS_IT1.jpg')",
            ...
            <div style={{ marginTop: '50px', fontSize: '20px', height: 'auto' }}>
                <p>
                    Drive Business Transformation with Strategic Staffing/IS/IT
                    At BitTwoByte, we offer comprehensive Staffing/IS/IT to help businesses navigate complex challenges and achieve sustainable growth.
            ...
            <div style={{ marginTop: '30px', padding: '0 10px', fontSize: 'calc(8px + 4vmin)', fontStyle: 'normal', color: '#012353 ', textAlign: 'center' }}>
                <h2>Our Staffing/IS/IT Offerings</h2>
            </div>
            ...
            <div className='containerStyle' style={{ alignItems: 'center', backgroundColor: 'white', width: 'auto' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '50px' }}>
                    <h1>Why Choose Us for Staffing/IS/IT?</h1>
                </div>

                {/* Expertise in Staffing/IS/IT */}
                <div className='Expertise' style={{ margin: '0px', textRendering: 'inherit', backgroundColor: 'white', transition: 'background-color 0.2s ease' }}>
                    <div className='heading' style={{ fontSize: '6px', color: '#000000', border: '3px solid #f5f4f375', fontSize: 'larger', justifyContent: 'space-between', display: 'flex', flexWrap: 'wrap', columnGap: '12px' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor = '#094409'; e.currentTarget.style.color = 'white'; }} onMouseOut={(e) => { e.currentTarget.style.backgroundColor = 'white'; e.currentTarget.style.color = 'black'; }}>
                        <div>
                            <h2>Expertise in Staffing/IS/IT</h2>
                        </div>
                        <div style={{ width: '50%' }}>
                            <p>Our team specializes in providing expert Staffing/IS/IT, offering strategic guidance and actionable insights to drive organizational excellence and achieve sustainable growth.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='Expertise' style={{ margin: '0px', textRendering: 'inherit', backgroundColor: 'white', transition: 'background-color 0.2s ease' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor = '#094409'; }}>
                    <div className='heading' style={{ fontSize: '6px', color: '#000000', border: '3px solid #f5f4f375', fontSize: 'larger', justifyContent: 'space-between', display: 'flex', flexWrap: 'wrap', columnGap: '12px' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor = '#094409'; e.currentTarget.style.color = 'white'; }} onMouseOut={(e) => { e.currentTarget.style.backgroundColor = 'white'; e.currentTarget.style.color = 'black'; }}>
                        ...
                        <div style={{ width: '50%' }}>
                            <p>We foster innovation and creativity in our Staffing/IS/IT approach, leveraging cutting-edge methodologies and best practices to deliver transformative solutions.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='Expertise' style={{ margin: '0px', textRendering: 'inherit', backgroundColor: 'white', transition: 'background-color 0.2s ease' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor = '#094409'; }}>
                    <div className='heading' style={{ fontSize: '6px', color: '#000000', border: '3px solid #f5f4f375', fontSize: 'larger', justifyContent: 'space-between', display: 'flex', flexWrap: 'wrap', columnGap: '12px' }} onMouseOver={(e) => { e.currentTarget.style.backgroundColor = '#094409'; e.currentTarget.style.color = 'white'; }} onMouseOut={(e) => { e.currentTarget.style.backgroundColor = 'white'; e.currentTarget.style.color = 'black'; }}>
                        ...
                        <div style={{ width: '50%' }}>
                            <p>We adopt a client-centric approach in our Staffing/IS/IT, prioritizing client needs and objectives to deliver customized solutions that drive tangible results.</p>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ marginTop: '30px', backgroundColor: '#012353', padding: '20px 10px', fontSize: 'calc(10px + 2vmin)', textAlign: 'center', color: 'white' }}>
                    <p>Transform your business with strategic Staffing/IS/IT from BitTwoByte Technologies Pvt. Ltd. Whether you need guidance on strategy development, performance improvement, or organizational transformation, our expert team is here to help. Contact us today to embark on your journey towards sustainable growth.</p>
